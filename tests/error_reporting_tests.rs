...
mod tests {
    ...
    #[test]
    fn test_isolated_type_errors() {
        check_isolated_errors(&["errors_types_isolated.dml"]);
    }

    #[test]
    fn test_isolated_hook_recovery_errors() {
        check_isolated_errors(&["errors_hook_recovery_isolated.dml"]);
    }
    ...
    #[test]
    fn test_pointer_indirection_survives_typedef_boundary() {
        check_device_errors(&["type_indirection_cycle_regression.dml"]);
    }
    ...
    #[test]
    fn test_method_type_matrix_errors() {
        check_device_errors(&["errors_methods_type_matrix.dml"]);
    }
