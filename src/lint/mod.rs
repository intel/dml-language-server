...
pub struct LintCfg {
    ...
    #[serde(default)]
    pub func_call_break_on_opening_paren: Option<FuncCallBreakOnOpenParenOptions>,
}
...
impl Default for LintCfg {
    fn default() -> LintCfg {
        LintCfg {
            ...
            func_call_break_on_opening_paren: Some(FuncCallBreakOnOpenParenOptions{indentation_spaces: INDENTATION_LEVEL_DEFAULT}),
        }
    }
}
